...
shinyServer(function(input, output){
  ...
  source("panels/panel-server-barplot.R", local = TRUE)
  source("panels/panel-server-rarefaction.R", local = TRUE)
  source("panels/panel-server-view.R", local = TRUE)
  source("panels/panel-server-sample.R", local = TRUE)
  source("panels/panel-server-preprocessing.R", local = TRUE)
  source("panels/panel-server-deseq2.R", local = TRUE)
  source("panels/panel-server-fa.R", local = TRUE)
