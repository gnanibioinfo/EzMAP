...
4. Next inside the EzMAP_Tool folder locate the compressed file EzMAP.zip and unzip/extract it (EzMAP_Tool>EzMAP>**EzMAP**) . Copy the folder and paste it on Desktop as **EzMAP** (This folder should consists of other sub-folders (build,dist,Downstream,.....)). [This should be like ~/Desktop/EzMAP/build.. ].
